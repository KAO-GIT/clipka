...
public class TskActionShowNotificationAlert extends TskActionAbstract
{

	public TskActionShowNotificationAlert(IRecord source)
	{
		super(source);
	}
	...
	public IResErrors runAction() throws Exception
	{
		...
		if (s != null && !s.isEmpty())
		{
			...
			NotiKA.showNotification(s, ResNamesWithId.VALUE_ALERT,
