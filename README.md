...
<a name=Clp></a>Окно сохраненных текстовых клипов буфера обмена.
...
"Выполнить код на языке Groovy"  
"Показать/скрыть сохраненный список буфера обмена"  

<a name=Flt></a>Фильтры окон
...
<a name=Aler></a>Оповещения и ошибки
