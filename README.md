...
Windows, так и под Linux. Поэтому я установил Eclipse (под будущее
использование EDT) и Java. Как обычно, хотелось сделать себе программу,
заодно и поизучать язык.
